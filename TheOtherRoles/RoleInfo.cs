...
{
    public static RoleInfo impostor = new RoleInfo("Impostor", Palette.ImpostorRed, cs(Palette.ImpostorRed, "Sabotage and kill everyone"), "Sabotage and kill everyone", RoleId.Impostor);
    ...
    public static RoleInfo hunter = new RoleInfo("Hunter", Palette.ImpostorRed, cs(Palette.ImpostorRed, "Seek and kill everyone"), "Seek and kill everyone", RoleId.Impostor);
